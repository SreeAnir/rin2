    ...
    <div class="card pt-3">
        <div class="card-body pt-3">
            <form action="{{ route('notification.store') }}" id="new_notification" method="POST">
                ...
                <div class="form-group row">
                    <label for="phone" class="col-sm-2 col-form-label">Expire On</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control datepicker" id="expire_on" name="expire_on"
                            autocomplete="off">
                        @error('expire_on')
                            <div class="invalid-feedback">
                                {{ $message }}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <select class="select2-multiple form-control" name="users[]" multiple="multiple" id="users">
